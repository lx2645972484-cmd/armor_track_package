...
{
  new (message_memory) armor_interfaces::msg::JointState(_init);
}

void JointState_fini_function(void * message_memory)
{
  auto typed_message = static_cast<armor_interfaces::msg::JointState *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember JointState_message_member_array[5] = {
  {
    ...
    offsetof(armor_interfaces::msg::JointState, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(armor_interfaces::msg::JointState, name),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(armor_interfaces::msg::JointState, position),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(armor_interfaces::msg::JointState, velocity),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(armor_interfaces::msg::JointState, effort),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers JointState_message_members = {
  ...
  5,  // number of fields
  sizeof(armor_interfaces::msg::JointState),
...
get_message_type_support_handle<armor_interfaces::msg::JointState>()
{
  return &::armor_interfaces::msg::rosidl_typesupport_introspection_cpp::JointState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, armor_interfaces, msg, JointState)() {
  return &::armor_interfaces::msg::rosidl_typesupport_introspection_cpp::JointState_message_type_support_handle;
}
