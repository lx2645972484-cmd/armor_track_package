...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ArmorInfo_message_member_array[2] = {
  {
    "yaw",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(armor_interfaces::msg::ArmorInfo, time),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
