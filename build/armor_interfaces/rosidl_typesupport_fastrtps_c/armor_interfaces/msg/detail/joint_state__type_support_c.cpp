...
#include "armor_interfaces/msg/detail/joint_state__rosidl_typesupport_fastrtps_c.h"
...
using _JointState__ros_msg_type = armor_interfaces__msg__JointState;
...
size_t get_serialized_size_armor_interfaces__msg__JointState(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _JointState__ros_msg_type * ros_message = static_cast<const _JointState__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _JointState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_armor_interfaces__msg__JointState(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_armor_interfaces
size_t max_serialized_size_armor_interfaces__msg__JointState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = armor_interfaces__msg__JointState;
    is_plain =
      (
...
static size_t _JointState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_armor_interfaces__msg__JointState(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, armor_interfaces, msg, JointState)() {
