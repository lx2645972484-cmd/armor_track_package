...
#include "armor_interfaces/msg/detail/armor_info__rosidl_typesupport_fastrtps_c.h"
...
using _ArmorInfo__ros_msg_type = armor_interfaces__msg__ArmorInfo;
...
static uint32_t _ArmorInfo__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_armor_interfaces__msg__ArmorInfo(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = armor_interfaces__msg__ArmorInfo;
    is_plain =
      (
...
static size_t _ArmorInfo__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_armor_interfaces__msg__ArmorInfo(
