...
#include "armor_interfaces/msg/detail/serial_receive_data__rosidl_typesupport_fastrtps_c.h"
...
using _SerialReceiveData__ros_msg_type = armor_interfaces__msg__SerialReceiveData;
...
size_t get_serialized_size_armor_interfaces__msg__SerialReceiveData(
  const void * untyped_ros_message,
...
static uint32_t _SerialReceiveData__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_armor_interfaces__msg__SerialReceiveData(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_armor_interfaces
size_t max_serialized_size_armor_interfaces__msg__SerialReceiveData(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = armor_interfaces__msg__SerialReceiveData;
    is_plain =
      (
...
static size_t _SerialReceiveData__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_armor_interfaces__msg__SerialReceiveData(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, armor_interfaces, msg, SerialReceiveData)() {
