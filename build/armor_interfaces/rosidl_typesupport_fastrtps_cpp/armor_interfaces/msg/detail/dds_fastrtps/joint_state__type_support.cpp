...
#include "armor_interfaces/msg/detail/joint_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const armor_interfaces::msg::JointState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  armor_interfaces::msg::JointState & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = armor_interfaces::msg::JointState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const armor_interfaces::msg::JointState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<armor_interfaces::msg::JointState *>(
    untyped_ros_message);
...
{
  return &armor_interfaces::msg::typesupport_fastrtps_cpp::_JointState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, armor_interfaces, msg, JointState)() {
  return &armor_interfaces::msg::typesupport_fastrtps_cpp::_JointState__handle;
}
