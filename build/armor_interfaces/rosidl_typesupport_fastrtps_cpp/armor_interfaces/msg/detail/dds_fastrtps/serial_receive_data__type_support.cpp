...
#include "armor_interfaces/msg/detail/serial_receive_data__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const armor_interfaces::msg::SerialReceiveData & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  armor_interfaces::msg::SerialReceiveData & ros_message)
{
  // Member: yaw
  cdr >> ros_message.yaw;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = armor_interfaces::msg::SerialReceiveData;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const armor_interfaces::msg::SerialReceiveData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<armor_interfaces::msg::SerialReceiveData *>(
    untyped_ros_message);
...
{
  return &armor_interfaces::msg::typesupport_fastrtps_cpp::_SerialReceiveData__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, armor_interfaces, msg, SerialReceiveData)() {
  return &armor_interfaces::msg::typesupport_fastrtps_cpp::_SerialReceiveData__handle;
}
