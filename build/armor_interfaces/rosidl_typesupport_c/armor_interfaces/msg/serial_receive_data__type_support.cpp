...
static const _SerialReceiveData_type_support_symbol_names_t _SerialReceiveData_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, armor_interfaces, msg, SerialReceiveData)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, armor_interfaces, msg, SerialReceiveData)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, armor_interfaces, msg, SerialReceiveData)() {
  return &::armor_interfaces::msg::rosidl_typesupport_c::SerialReceiveData_message_type_support_handle;
}
