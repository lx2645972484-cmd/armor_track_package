...
static const _SerialReceiveData_type_support_symbol_names_t _SerialReceiveData_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, armor_interfaces, msg, SerialReceiveData)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, armor_interfaces, msg, SerialReceiveData)),
  }
};
...
{
  return &::armor_interfaces::msg::rosidl_typesupport_cpp::SerialReceiveData_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, armor_interfaces, msg, SerialReceiveData)() {
  return get_message_type_support_handle<armor_interfaces::msg::SerialReceiveData>();
}
