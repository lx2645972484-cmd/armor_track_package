...
bool armor_interfaces__msg__joint_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("armor_interfaces.msg._joint_state.JointState", full_classname_dest, 44) == 0);
  }
  armor_interfaces__msg__JointState * ros_message = _ros_message;
  {  // header
...
PyObject * armor_interfaces__msg__joint_state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("armor_interfaces.msg._joint_state");
